...
function Home(props) {
    ...
    const cekOngkir = (e) => {
        setLoading(true);
        axios
            .post("https://ongkir.apsyadira.com/cek_harga", {
                kota_asal: kotaAsal,
                type_asal: "city",
    ...
    const cekResi = (e) => {
        ...
        setError(false);
        axios
            .post("https://ongkir.apsyadira.com/check_resi", {
                resi: data.resi,
                kurir: data.kurir,
            })
            .then((res) => {
    ...
    useEffect(() => {
        axios.get("https://ongkir.apsyadira.com/kota").then((res) => setKota(res.data.data));
    }, []);
